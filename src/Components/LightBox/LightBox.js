...
export default function Lightbox() {
  ...
  const modalImages = [Product1, Product2, Product3]
    ...
    <main className='lightbox-container'>
      <div className='lightbox-images'>
        ...
        <div id='lightbox-thumbnails'>
          ...
          >
            <img
              className={`lightbox-thumbnails-img ${
      ...
      <div className='lightbox-txt'>
        <p className='lightbox-txt-title'>Move On COMPANY</p>
        <p className='lightbox-txt-fall'>Mesh Sneakers Gray Tennis Shoes</p>
        <p className='lightbox-txt-desc'>
        ...
        <div className='prices'>
          <div className='prices-flex'>
            <span className='price'>$24.41</span>
            <span className='price-off'>40%</span>
          </div>
          <p className='price-before'>$38.22</p>
        </div>
